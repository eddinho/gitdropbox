...
4. Update [README.md](../README.md) and [doc/CHANGELOG.md](CHANGELOG.md) when user-facing behavior changes.

## Release Process
Maintainers should follow [doc/RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md) before publishing.
